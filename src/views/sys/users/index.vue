<template>
  <PageWrapper title="用户管理">
    <BasicTable @register="registerTable">
      ...
      <template #toolbar>
        <a-button type="primary" v-auth="'AbpIdentity.Users.Create'" @click="openCreateAbpUserModal"
          >新增</a-button
        >
      </template>
    ...
    <ReSetPassWord
      @register="registerReSetPassWordModal"
      @reload="reload"
      :bodyStyle="{ 'padding-top': '0' }"
    />
    <ManageClaims
...
<script lang="ts">
  ...
  import { tableColumns, getTableListAsync, deleteUserAsync, searchFormSchema } from './index';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const [registerTable, { reload }] = useTable({
        ...
        const openPermissions = async (record: Recordable) => {
